...
public class UpdateUserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String userSelectedEmail = getIntent().getStringExtra("SELECTED_USER_EMAIL");
        ...
        documentReference = db.collection("users").document(userSelectedEmail);
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(UpdateUserActivity.this, UserData.class));
            }
        });
